...
public final class MapEntries implements IdentifiedDataSerializable {
    ...
    private static final class SerializableObjectValueWrapper implements ValueWrapper {
        ...
        @Override
        public String toString() {
            return "SerializableObjectValueWrapper [value=" + this.value + ", serializationService=" + this.serializationService + "]";
        }
    }
    ...
    public void putAllToList(Collection<Map.Entry<Data, Data>> targetList) {
        ...
        while (keyIterator.hasNext()) {
            targetList.add(new AbstractMap.SimpleImmutableEntry<Data, Data>(keyIterator.next(), valueIterator.next().getValueAsData()));
        }
    }
