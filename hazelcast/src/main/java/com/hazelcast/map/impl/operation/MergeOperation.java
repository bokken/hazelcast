...
public class MergeOperation extends BasePutOperation {
    ...
    public void run() {
        ...
        if (oldRecord != null) {
            ...
            this.oldValue = this.mapContainer.getMapConfig().isForceDefensiveCopy() ? mapServiceContext.toData(putResult) : putResult;
        }
    ...
    public void afterRun() {
        if (merged) {
            ...
            mapEventPublisher.publishEvent(getCallerAddress(), name, EntryEventType.MERGED, dataKey, oldValue,
